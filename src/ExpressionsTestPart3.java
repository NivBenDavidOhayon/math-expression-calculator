...
public class ExpressionsTestPart3 {
     ...
     * The Grade part 3.
     */
    private static int gradePart3 = 0;
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            e = new Pow(new Minus(new Mult(new Num(2.0), new Num(8.0)),
                    new Num(6.0)), new Num(2.0));
            value = e.evaluate();
            if (value == 100) {
                gradePart3++;
                System.out.println("Test 43");
        ...
        try {
            ...
            // ans : 0
            e = new Mult(new Pow(new Minus(new Mult(new Num(2.0), new Num(8.0)),
                    new Num(6.0)), new Num(2.0)), new Num(0.0));
            value = e.evaluate();
        ...
        try {
            ...
            // 100 / 100 = 1
            e = new Div(new Pow(new Minus(new Mult(new Num(2.0), new Num(8.0)), new Num(6.0)),
                    new Num(2.0)), new Pow(new Minus(new Mult(new Num(2.0),
                    new Num(8.0)), new Num(6.0)), new Num(2.0)));
            e = e.simplify();
        ...
        try {
            ...
            e = new Mult(new Plus(new Plus(new Mult(new Var("x"), new Num(2.0)),
                    new Mult(new Var("x"), new Num(2.0))),
                    new Plus(new Mult(new Var("x"),
                            new Num(2.0)), new Mult(new Var("x"), new Num(2.0)))),
                    new Num(1.0));
        ...
        try {
            ...
            e = new Mult(new Pow(new Var("e"), new Pow(new Minus(new Mult(new Num(2.0),
                    new Num(8.0)), new Num(6.0)),
                    new Num(2.0))), new Num(1.0));
            e = e.simplify();
        ...
        try {
            ...
            // ans ---> 23
            e = new Div(new Plus(new Mult(new Minus(new Num(12.0), new Num(3.0)),
                    new Num(8.0)), new Num(20.0)), new Num(4.0));
        ...
        // ans = 0
        try {
            Expression a1 = new Plus(new Plus(new Plus(new Num(-1.0), new Num(1.0)),
                    new Plus(new Num(-1.0), new Num(1.0))), new Plus(new Plus(new Num(-1.0),
                    new Num(1.0)), new Plus(new Num(-1.0), new Num(1.0))));
        ...
        try {
            ...
            // ((x^5.0) - (x^5.0))
            // 5x^4 - 5x^4
            e = new Minus(new Pow(new Var("x"), new Num(5.0)),
                    new Pow(new Var("x"), new Num(5.0)));
        ...
        try {
            ...
            e = new Minus(new Num(0.0), new Pow(new Var("e"), new Mult(new Var("x"),
                    new Num(2.0))));
            assignment.clear();
...
//            value  = Double.parseDouble(new DecimalFormat("##.###").format(value));
        ...
        try {
            ...
            e = new Minus(new Minus(new Num(0.0), new Num(0.0)),
                    new Minus(new Num(0.0), new Pow(new Var("e"),
                            new Mult(new Var("x"), new Num(2.0)))));
        ...
        try {
            // ((Log((2.0 * z), (2.0 * z))) * x)
            // Log(2z,2z) * x = x
            e = new Mult(new Log(new Mult(new Num(2.0), new Var("z")), new Mult(new Num(2.0),
                    new Var("z"))), new Var("x"));
        ...
        try {
            ...
            e = new Mult(new Mult(new Log(new Mult(new Num(2.0), new Var("z")),
                    new Mult(new Num(2.0), new Var("z"))),
                    new Cos(new Num(0.0))), new Sin(new Num(90.0)));
        ...
        try {
            ...
            e = new Plus(new Mult(new Plus(new Num(3.0), new Num(10.0)), new Var("x")),
                    new Mult(new Mult(new Var("y"), new Num(15.0)), new Sin(new Num(0.0))));
        ...
        try {
            ...
            e = new Mult(new Mult(new Mult(new Mult(new Num(20.0), new Pow(new Var("x"),
                    new Num(5.0))), new Mult(new Num(3.0), new Pow(new Var("e"),
                    new Var("x")))), new Cos(new Pow(new Var("x"),
                    new Num(2.0)))), new Minus(new Var("x"), new Var("x")));
        ...
        try {
            // ((((20.0 * (x^5.0)) + (3.0 * (e^x))) * (Cos((x^2.0)))) + (x - x))
            // answer is : 3.0
            e = new Plus(new Mult(new Plus(new Mult(new Num(20.0), new Pow(new Var("x"),
                    new Num(5.0))), new Mult(new Num(3.0), new Pow(new Var("e"),
                    new Var("x")))), new Cos(new Pow(new Var("x"),
                    new Num(2.0)))), new Minus(new Var("x"), new Var("x")));
            assignment.clear();
        ...
        try {
            ...
            e = new Mult(new Mult(new Mult(new Pow(new Var("e"), new Var("x")),
                    new Pow(new Var("e"), new Var("x"))), new Mult(new Pow(new Var("e"),
                    new Var("x")), new Pow(new Var("e"), new Var("x")))), new Num(0.0));
            e = e.assign("x", new Num(4.0));
        ...
        try {
            ...
            e = new Mult(new Div(new Mult(new Pow(new Var("e"), new Var("x")),
                    new Pow(new Pow(new Var("e"), new Var("x")),
                            new Num(2.0))), new Pow(new Pow(new Var("e"), new Var("x")),
                    new Num(3.0))), new Div(new Mult(new Pow(new Pow(new Var("e"),
                    new Var("x")), new Num(4.0)), new Pow(new Pow(new Var("e"),
                    new Var("x")), new Num(3.0))), new Pow(new Pow(new Var("e"),
                    new Var("x")), new Num(7.0))));
        ...
        try {
            e = new Mult(new Div(new Div(new Mult(new Pow(new Var("e"), new Var("x")),
                    new Pow(new Pow(new Var("e"), new Var("x")), new Num(2.0))),
                    new Pow(new Pow(new Var("e"), new Var("x")), new Num(3.0))),
                    new Div(new Mult(new Pow(new Pow(new Var("e"), new Var("x")),
                            new Num(4.0)), new Pow(new Pow(new Var("e"), new Var("x")),
                            new Num(3.0))), new Pow(new Pow(new Var("e"),
                            new Var("x")), new Num(7.0)))), new Sin(new Num(0.0)));
